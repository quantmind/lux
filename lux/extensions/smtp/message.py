'''Email messages, adapted from django
'''
import mimetypes
import os
import random
...
class EmailMessage:
    ...
    def __init__(self, subject='', body='', from_email=None,
                 ...
                 headers=None, cc=None, reply_to=None, encoding=None):
        """
...
class EmailMultiAlternatives(EmailMessage):
    ...
    def __init__(self, subject='', body='', from_email=None, to=None, bcc=None,
                 ...
                 alternatives=None, cc=None, reply_to=None, encoding=None):
        """
        Initialize a single email message (which can be sent to multiple
        recipients).
        ...
        super().__init__(subject, body, from_email, to, bcc, connection,
                         attachments, headers, cc, reply_to, encoding=encoding)
